            ...
            <div className="row">
                    ...
                    <div className="group-icon">
                        <div className="box-icons d-flex rounded-3">
                            <div className="images me-3">
                                <img src="src/assets/footer-assets/jeftine_kuce_footer_1.png" alt="" />
                            </div>
                ...
                <div className="col-12 col-lg-6 mb-5">
                    <div className="group-icon">
                        <div className="box-icons d-flex rounded-3">
                            <div className="images me-3">
                                <img src="src/assets/footer-assets/jeftine_kuce_footer_2.png" alt="img-footer-2" />
                            </div>
                ...
                <div className="col-12 col-md-6 col-lg-2 mb-5">
                    <div className="widget-info text-white">
                        ...
                        <ul className="footer-nav-menu list-unstyled">
